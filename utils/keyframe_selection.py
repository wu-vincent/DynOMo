...
def keyframe_selection_overlap(gt_depth, w2c, intrinsics, keyframe_list, k, pixels=1600, take_last_two=True):
        """
        ...
        """
        if take_last_two:
            if len(keyframe_list):
                selected_keyframe_list = [keyframe_list[-1]['id']]
