...
if __name__ == "__main__":
    ...
    experiment_args = dict(
        ...
        kNN=20,
        desired_image_height=256, # 240, # 120, #240, #480, 180, 360
        desired_image_width=256, # 455, # 227, # 455, #910, 320, 640
        instseg_obj=0.0,
        instseg_cam=0.0,
        smoothness=0,
