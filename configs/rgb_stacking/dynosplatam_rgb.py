...
config = dict(
    ...
    data=dict(
        basedir="/data3/jseidens/tapvid_rgb_stacking",
        gradslam_data_cfg="./configs/data/rgb_stacking.yaml",
        sequence=scene_name,
        desired_image_height=256, #480,
        desired_image_width=256, #910,
        start=0,
        end=num_frames,
        stride=1,
