...
mapping_iters = 0
mov_init_by = 'sparse_flow_simple'
...
config = dict(
    ...
    run_name=run_name,
    checkpoint='experiments/dynosplatam_jono/splatam_softball/ims/27_0_sparse_flow_simple',
    seed=seed,
    ...
    tracking_obj=dict(
        ...
        calc_ssmi=True,
        bg_reg=False,
        use_flow='pytorch_simple', # 'rendered' # None
        loss_weights=dict(
            im=1.0,
            delta_im=1.0,
            next_im=1.0,
