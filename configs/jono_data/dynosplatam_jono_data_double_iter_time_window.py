...
mapping_iters = 0
mov_init_by = 'per_point_delta'

group_name = "dynosplatam_jono"
run_name = f"splatam_{scene_name}_{seed}_{mov_init_by}_window_16_1000"
...
config = dict(
    ...
    data=dict(
        ...
        sequence=scene_name,
        desired_image_height=180, #180, #90, #360,
        desired_image_width=320, #320, #160, #640,
        start=0,
        end=-1,
        stride=1,
        num_frames=32,
